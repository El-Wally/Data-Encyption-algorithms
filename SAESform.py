...
def Encode(key, Plain):
    ...
    plain = Plain.split()
    #print(Key)
    alpha = list(map(int, Key))
    alpha2 = list(map(int, plain))
    #print("Alpha: ",alpha)
    plain = alpha2
    Key = alpha
...
def formcreate2():
    ...
    sub_btn = tk.Button(root, text='Encrypt', command=lambda: res_ent.insert(0, Encode(Key_ent.get(), Txt_ent.get())))
